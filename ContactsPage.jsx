...
/**
 * @param {{ label: string, value: string, icon?: import('react').ReactNode }} props
 */
...
/**
 * @param {{ contact: import('./ContactsPage').Contact | null }} props
 */
        ...
        <div className="grid grid-cols-2 gap-5">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex items-center justify-between">
              ...
              <span
                className={contact.enriched
                  ? "text-[8px] px-1.5 py-0.5 rounded-full font-display border text-emerald-400 border-emerald-400/30"
                  : "text-[8px] px-1.5 py-0.5 rounded-full font-display border text-white/25 border-white/15"}
              >
              ...
              <div className="flex flex-col gap-1">
                {filtered.map((c) => (
                  <button
                    ...
                    className={
                      selected?.id === c.id
                        ? "w-full text-left px-2 py-2 rounded-lg transition-colors glass-crimson border border-primary/20"
                        : "w-full text-left px-2 py-2 rounded-lg transition-colors hover:bg-white/3 border border-transparent"
                    }
                  >
