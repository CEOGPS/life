...
export default function DashboardPanel({ setActive }) {
  ...
  return (
    <div style={{ minHeight: '100%', background: 'transparent', padding: '20px 28px' }}>
      ...
      <div style={grid}>
        {/* ── ROW 1: TASKS / LINKS / LEADS / TIME & WEATHER (4 modules) ── */}
        <GridCard title="TASKS" icon={<CheckSquare size={14} />} gridColumn="span 3">
        ...
        <GridCard title="LINKS" icon={<FolderKanban size={14} />} gridColumn="span 3">
        ...
        <GridCard title="LEADS" icon={<Contact size={14} />} gridColumn="span 3">
          <div style={{ display: "flex", flexDirection: "column", gap: 4, fontSize: 11, color: "var(--t2)" }}>
        ...
        {/* ── ROW 1 (cont.): Time & Weather completes the 4-module top row ── */}
        <GridCard title="Time & Weather" icon={<Calendar size={14} />} gridColumn="span 3">
          <ClockWidget />
        </GridCard>

        {/* ── ROW 2: This Week / Notes ── */}
        <GridCard 
          title="This Week" 
        ...
        <GridCard title="NOTES" icon={<BookOpen size={14} />} gridColumn="span 5">
